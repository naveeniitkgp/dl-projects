...
if __name__ == '__main__':
    ...
    FREUD_MODEL = fk4r_freud(input_dim=config.input_dim_freud, hidden_dims=config.hidden_dims_freud,
    ...
    summary(FREUD_MODEL, input_size=input_shape,
            col_names=['input_size', 'output_size']) if config.Print_Model_Summary else None
